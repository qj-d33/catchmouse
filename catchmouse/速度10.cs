...
namespace catchmouse
{
    public partial class 速度10 : Form
    {
        ...
        private void InitializeGame()
        {
            ...
            mouse.SizeMode = PictureBoxSizeMode.StretchImage;//設置了 PictureBox 控件中圖像的顯示方式為拉伸（StretchImage），Zoom為壓縮
        ...
        private void Form1_Load(object sender,EventArgs e)
        {
            ...
            this.BackgroundImageLayout = ImageLayout.Stretch;// 設置圖片布局，可根据需要調整
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)//KeyDown 事件處理程序中，可以檢查 e.KeyCode 的值來確定用户按下了哪个鍵，並相應地執行相應的操作。
        {
            // 移動猫
            int step = 10;
